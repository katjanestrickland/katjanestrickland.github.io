...
One topic central to the debate around ethical use of algorithm is that of mis-classification costs. By building in asymmetric costs through sampling, maching learning engineers can take heed of policy makers' desired cost-ratios. In this project, I investigate how sample size selection affects cost asymmetry in the context of a supervised learning algorithm. This particular random forest algorithm predicts death rates of coronavirus patients in South Korea using the <a href = "https://www.kaggle.com/allen-institute-for-ai/CORD-19-research-challenge/" target = "_blank"> Kaggle </a>COVID-19 Open Research Dataset.
