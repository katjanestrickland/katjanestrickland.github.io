...
#### Results
Neuroticism and Openness, of all the Big 5 constructs, differed most for pitchers and hitters. A new survey tool for the team based on the clustering results among the Big 5 Factors shift player recruitment strategies to one based on "team cohesion" rather than individual psych rankings.
...
#### Overview
Trending videos on YouTube do not simply increase viewership, they also inspire new content and engagement from creators. With such a large and diverse dataset of videos, product teams rely on unsupervised learning methods to find groups based on features such number of views or likes. Using <a href = "https://www.kaggle.com/datasnaek/youtube-new/" target = "_blank"> a large dataset </a> of YouTube videos, we explore trends to guide the marketing team.
...
#### Results
Our algorithm identified three clusters of categories by views and comments: conversation starts, niche blockbusters, and silent movies. These defined groups guide the product and partnernship teams to support music and gaming influencers, the advertising team to stragicially adjust cost per views for advertisers in more popular categories, and the YouTube pricing team to attract paid users with new, cross-category videos.
...
See <a href = "https://github.com/katjanewilson/YouTube" target = "_blank"> GitHub repo </a> for full code and analysis.
