...
As a result of the Covid-19 economic and social shutdown in March of 2020, Evite's event business changed. Using Evite's historical event data, and publicly available Covid-19 related data (cases/deaths and city reopening phases), we predict the number of events in particular locations.
...
<div class="col-sm-6">
```{r vertical2, out.width=200, echo=F}
...
<a href = "https://katjanewilson.github.io/WhartonAnalytics-MLB/" target = "_blank"> project page </a>
