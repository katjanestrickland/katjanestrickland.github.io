...
Using a popular <a href = "https://www.kaggle.com/datasnaek/youtube-new/" target = "_blank"> Kaggle dataset </a> on trending videos from YouTube, I build an unsupervised learning algorithm to find trends on over 6,000 trending videos. Clustering results inform sales team on pricing strategies for ads, or the product team to better understand content creation. 
